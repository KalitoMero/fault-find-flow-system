...
const AccountCreationForm: React.FC<AccountCreationFormProps> = ({ onAccountCreated }) => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Neuen Account erstellen</CardTitle>
        <CardDescription>
          Erstellen Sie einen neuen Benutzer-Account mit Benutzername und Passwort
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div>
          <Label htmlFor="personal-number">Personalnummer (optional)</Label>
          <Input
            id="personal-number"
            type="text"
        ...
        <Button 
          ...
          className="w-full"
        >
          {isCreating ? 'Erstelle Account...' : 'Account erstellen'}
        </Button>
      </CardContent>
    </Card>
  );
